...
class YearlyAudit extends Model
{
    protected $table = 'tr_acc_yearly_audit';
    ...
    public function scopeVersionHistory(Builder $query, $year)
    {
        return $query->where('audit_year', $year)->orderBy('version_number', 'desc');
    }
