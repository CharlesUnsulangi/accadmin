        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-5">
                    ...
                    <a href="{{ route('closing.process') }}" class="btn btn-primary">
    ...
    return {
        ...
        async loadData() {
            ...
            try {
                ...
                const response = await fetch(`{{ route('closing.history.data') }}?${params}`, {
                    method: 'GET',
                    headers: {
        ...
        exportExcel() {
            ...
            window.location.href = `{{ route('closing.history.export') }}?${params}`;
        }
    };
}
</script>
