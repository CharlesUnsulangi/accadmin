...
@section('title', 'Closing Process - 3 Layer System')
...
function closingProcess() {
    return {
        ...
        async preview() {
            ...
            try {
                const response = await fetch('{{ route("closing.preview") }}', {
                    method: 'POST',
                    headers: {
        ...
        async generate() {
            ...
            try {
                const response = await fetch('{{ route("closing.generate") }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
        ...
        async compareWithAudit() {
            ...
            try {
                const response = await fetch('{{ route("closing.compare-audit") }}', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '{{ csrf_token() }}'
