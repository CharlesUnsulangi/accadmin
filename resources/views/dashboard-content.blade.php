        ...
        <div class="col-lg-4">
            <div class="table-container" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; height: 100%;">
                <div class="text-center">
                    ...
                    <div class="mb-3">
                        <div class="fs-2 fw-bold">{{ number_format($hierarchyStats['h1'] ?? 0) }}</div>
                        <small>Main Categories</small>
                    </div>
                    <a href="{{ route('coa.modern') }}" class="btn btn-light w-100">
        ...
        <div class="col-lg-4">
            <div class="table-container" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white; height: 100%;">
                <div class="text-center">
                    ...
                    <div class="mb-3">
                        <div class="fs-2 fw-bold">{{ number_format($coaStats['total']) }}</div>
                        <small>Total Accounts</small>
                    </div>
                    <a href="{{ route('coa.legacy') }}" class="btn btn-light w-100">
        ...
        <div class="col-lg-4">
            <div class="table-container" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white; height: 100%;">
                <div class="text-center">
                    ...
                    <div class="mb-3">
                        <div class="fs-2 fw-bold">{{ number_format($coaStats['active']) }}</div>
                        <small>Active Accounts</small>
                    </div>
                    <a href="{{ route('coa.hierarchy') }}" class="btn btn-light w-100">
        ...
        <div class="col-lg-6">
            <div class="table-container" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white;">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        <a href="{{ route('closing.balance-sheet') }}" class="btn btn-light w-100 text-start" style="padding: 0.75rem;">
                    ...
                    <div class="col-6">
                        <a href="{{ route('closing.process') }}" class="btn btn-light w-100 text-start" style="padding: 0.75rem;">
                    ...
                    <div class="col-6">
                        <a href="{{ route('closing.version-history') }}" class="btn btn-light w-100 text-start" style="padding: 0.75rem;">
                    ...
                    <div class="col-6">
                        <a href="{{ route('closing.rollback') }}" class="btn btn-light w-100 text-start" style="padding: 0.75rem;">
            ...
            <div class="table-container" style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%);">
                ...
                <div class="row g-3">
                    <div class="col-md-3 col-sm-6">
                        <a href="{{ route('coa.modern') }}" class="btn btn-outline-primary w-100 text-start" style="padding: 1rem; border-width: 2px;">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <a href="{{ route('overview') }}" class="btn btn-outline-warning w-100 text-start" style="padding: 1rem; border-width: 2px;">
                            ...
                            <div class="d-flex align-items-start">
                                <div class="me-3">
                                    <div style="width: 48px; height: 48px; background: rgba(255,255,255,0.25); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                                        <i class="fas {{ $activity['icon'] }} fs-4"></i>
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <h6 class="mb-1" style="font-weight: 600; color: white;">{{ $activity['title'] }}</h6>
                                    <p class="mb-1" style="font-size: 0.85rem; color: rgba(255,255,255,0.9);">{{ $activity['description'] }}</p>
