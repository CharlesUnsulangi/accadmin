        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-4xl font-bold mt-2 text-white">{{ $coaStats['total'] }}</h3>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-4xl font-bold mt-2 text-white">{{ $coaStats['active'] }}</h3>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-4xl font-bold mt-2 text-white">{{ $coaStats['inactive'] }}</h3>
            ...
            <div class="space-y-4">
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-blue-600">{{ $hierarchyStats['h1'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h1'] > 0 ? ($hierarchyStats['h1'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-green-600">{{ $hierarchyStats['h2'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-green-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h2'] > 0 ? ($hierarchyStats['h2'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-purple-600">{{ $hierarchyStats['h3'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-purple-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h3'] > 0 ? ($hierarchyStats['h3'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-orange-600">{{ $hierarchyStats['h4'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-orange-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h4'] > 0 ? ($hierarchyStats['h4'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-pink-600">{{ $hierarchyStats['h5'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-pink-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h5'] > 0 ? ($hierarchyStats['h5'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-1">
                        ...
                        <span class="text-sm font-bold text-indigo-600">{{ $hierarchyStats['h6'] }}</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-indigo-600 h-2 rounded-full" style="width: {{ $hierarchyStats['h6'] > 0 ? ($hierarchyStats['h6'] / max(array_values($hierarchyStats)) * 100) : 0 }}%"></div>
                    </div>
                </div>
                ...
                <div class="border-t pt-3 mt-2">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-sm font-bold text-gray-900">{{ $hierarchyStats['total'] }}</span>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="w-3 h-3 rounded-full mr-3 
                                ...
                                {{ $type === 'Revenue' ? 'bg-purple-500' : '' }}
                                {{ $type === 'Expense' ? 'bg-orange-500' : '' }}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('coa.index') }}" class="text-sm text-blue-600 hover:text-blue-800">View All →</a>
            </div>
            <div class="space-y-3">
                @forelse($recentCoas as $coa)
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex-1">
                        <p class="text-sm font-medium text-gray-900">{{ $coa->coa_code }}</p>
                        <p class="text-xs text-gray-500">{{ $coa->coa_desc }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-gray-500">{{ $coa->rec_datecreated->diffForHumans() }}</p>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    ...
                    <div class="text-right">
                        <p class="text-xs text-gray-500">{{ $coa->rec_dateupdate->diffForHumans() }}</p>
                        <p class="text-xs text-gray-400">by {{ $coa->rec_userupdate }}</p>
                    </div>
                </div>
                @empty
                <div class="text-center py-8 text-gray-500">
