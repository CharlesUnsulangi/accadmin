<div>
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="<?php echo e(route('coa.legacy')); ?>" class="px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-4 text-white">
            ...
            <p class="text-3xl font-bold mt-1"><?php echo e($coas->total()); ?></p>
        </div>
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-4 text-white">
            ...
            <p class="text-3xl font-bold mt-1"><?php echo e($coas->count()); ?></p>
        </div>
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-lg shadow-lg p-4 text-white">
            ...
            <p class="text-3xl font-bold mt-1"><?php echo e($perPage); ?></p>
        </div>
    </div>
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $coas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-mono font-bold text-gray-900"><?php echo e($coa->coa_code); ?></div>
                                <div class="text-xs text-gray-500">ID: <?php echo e($coa->coa_id); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($coa->coa_desc); ?></div>
                                <!--[if BLOCK]><![endif]--><?php if($coa->coa_note): ?>
                                    <div class="text-xs text-gray-500 mt-1"><?php echo e($coa->coa_note); ?></div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-xs space-y-1">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($coa->desc_h4): ?>
                                        <div class="flex items-center gap-2 ml-12">
                                            ...
                                            <span class="text-gray-700"><?php echo e($coa->desc_h4); ?></span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($coa->desc_h5): ?>
                                        <div class="flex items-center gap-2 ml-16">
                                            ...
                                            <span class="text-gray-700"><?php echo e($coa->desc_h5); ?></span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($coa->desc_h6): ?>
                                        <div class="flex items-center gap-2 ml-20">
                                            ...
                                            <span class="text-gray-700"><?php echo e($coa->desc_h6); ?></span>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <!--[if BLOCK]><![endif]--><?php if($coa->coa_coasub2code): ?>
                                    <div class="text-xs">
                                        <span class="px-2 py-1 bg-orange-100 text-orange-800 rounded font-medium">
                                            <?php echo e($coa->coa_coasub2code); ?>

                                        </span>
                                        <!--[if BLOCK]><![endif]--><?php if($coa->sub2_desc): ?>
                                            <div class="text-gray-600 mt-1"><?php echo e($coa->sub2_desc); ?></div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                <?php else: ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="text-xs space-y-1">
                                    <div class="text-gray-600">
                                        ...
                                        <?php echo e($coa->rec_usercreated ?? '-'); ?>

                                    </div>
                                    <div class="text-gray-500">
                                        <?php echo e($coa->rec_datecreated ? $coa->rec_datecreated->format('d/m/Y H:i') : '-'); ?>

                                    </div>
                                    <!--[if BLOCK]><![endif]--><?php if($coa->rec_userupdate && $coa->rec_userupdate != $coa->rec_usercreated): ?>
                                        <div class="text-gray-600 mt-2">
                                            <i class="fas fa-user-edit mr-1"></i>
                                            <?php echo e($coa->rec_userupdate); ?>

                                        </div>
                                        <div class="text-gray-500">
                                            <?php echo e($coa->rec_dateupdate ? $coa->rec_dateupdate->format('d/m/Y H:i') : '-'); ?>
                ...
                <div class="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                        <h3 class="text-xl font-bold text-gray-800">
                            <?php echo e($editMode ? 'Edit COA' : 'Add New COA'); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text" wire:model="coa_code" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['coa_code'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input type="text" wire:model="coa_id" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['coa_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['coa_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="md:col-span-3">
                                        ...
                                        <input type="text" wire:model="coa_desc" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['coa_desc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        ...
                                        <input type="text" wire:model="ms_coa_h1_id" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['ms_coa_h1_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['ms_coa_h1_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-xs text-red-500"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div class="md:col-span-3">
                                        ...
                                        <input type="text" wire:model="desc_h1" 
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['desc_h1'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
<?php /**PATH C:\ProjectSoftwareCWU\laravel\AccAdmin\resources\views/livewire/coa-modern-management.blade.php ENDPATH**/ ?>